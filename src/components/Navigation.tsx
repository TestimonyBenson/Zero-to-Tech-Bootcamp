      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-16 flex items-center justify-between">
          ...
          <a
            ...
            className="text-sm font-medium tracking-widest text-white hover:text-[#39FF14] transition-colors duration-300"
          >
        ...
        <div className="flex flex-col items-center justify-center h-full gap-8">
          {navigationConfig.items.map((item, i) => (
            <a
              ...
              href={item.href}
              onClick={(e) => handleNavClick(e, item.href)}
              className="text-2xl text-white hover:text-[#39FF14] transition-colors duration-300"
              style={{
